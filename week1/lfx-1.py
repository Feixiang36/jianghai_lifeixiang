#SMA(DELAY(CLOSE/DELAY(CLOSE,19),1),12,1)
# coding=utf8
__author__ = 'lifx'
...
class Factor(FactorBase):
    ...
    def __init__(self):
        ...
        self.needFields = [t.CLOSE, t.ADJFCT, t.OPEN,t.VOLUME,t.HIGH]  ###设置需要的字段
    ...
    def factor_definition(self):                                          ###
        ...
        distrib=self.calculator.Delay(adjClose/self.calculator.Delay(adjClose,19),1)
